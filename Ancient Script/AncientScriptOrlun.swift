...
protocol WebLoadable: AnyObject {
    var state: AncientScriptWebStatus { get set }
...
final class AncientScriptWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
    // MARK: - Свойства

  @Published var state: AncientScriptWebStatus = .standby
    ...
    func observeProgression() {
        progressPublisher
            ...
            .sink { [weak self] progress in
                ...
                let newState: AncientScriptWebStatus = progress < 1.0 ? .progressing(progress: progress) : .finished
...
extension AncientScriptWebLoader: WKNavigationDelegate {
...
extension AncientScriptWebLoader {
    ...
    func publish(_ newState: AncientScriptWebStatus) {
...
private extension AncientScriptWebLoader {
    func updateState(_ newState: AncientScriptWebStatus) {
