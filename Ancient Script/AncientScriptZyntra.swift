...
final class AncientScriptBaseWebViewController: UIViewController, WKScriptMessageHandler {
    ...
    private let loader: AncientScriptWebLoader
    private let coordinator: AncientScriptWebCoordinator
    ...
    init(
        ...
        loader: AncientScriptWebLoader,
        coordinator: AncientScriptWebCoordinator,
    ...
    override func viewDidLoad() {
        ...
        AncientScriptOrientationManager.shared.updateAllowedOrientations(defaultOrientations)
    ...
    private func unlockOrientationIfNeeded() {
        ...
        AncientScriptOrientationManager.shared.updateAllowedOrientations(.all)
    }
...
private extension AncientScriptBaseWebViewController {
