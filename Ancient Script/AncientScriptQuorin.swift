...
class AncientScriptWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    private let callback: (AncientScriptWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (AncientScriptWebStatus) -> Void) {
