...
enum AncientScriptWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: AncientScriptWebStatus) -> Bool {
        switch (self, other) {
...
extension AncientScriptWebStatus {
...
extension AncientScriptWebStatus {
    static func == (lhs: AncientScriptWebStatus, rhs: AncientScriptWebStatus) -> Bool {
